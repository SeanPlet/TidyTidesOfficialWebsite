...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center ocean-surface">
      ...
      <div className="relative z-20 text-center max-w-4xl mx-auto px-6">
        ...
        {/* Main Title */}
        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold font-sour-gummy text-primary mb-6 drop-shadow-lg break-words" style={{WebkitTextStroke: '4.6px #004258'}}>
          Dive Into The 

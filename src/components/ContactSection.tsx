    ...
    <section className="py-16 ocean-deeper relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold font-sour-gummy text-primary mb-6 break-words text-outline">
            Stay Connected
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          ...
          <div className="relative">
            ...
            <Card className="relative z-10 underwater-glass border-border/30 hover:border-primary/50 transition-all duration-300 flex flex-col hover:scale-105 hover:shadow-xl hover:shadow-primary/20">
              <CardContent className="p-8 text-center flex flex-col flex-1">
                ...
                <h3 className="text-2xl font-bold font-sour-gummy text-primary mb-4">
                  Join Our Discord
                </h3>
          ...
          <Card className="underwater-glass border-border/30 hover:border-accent/50 transition-all duration-300 flex flex-col hover:scale-105 hover:shadow-xl hover:shadow-accent/20">
            <CardContent className="p-8 text-center flex flex-col flex-1">
              ...
              <h3 className="text-2xl font-bold font-sour-gummy text-accent mb-4">
                Email the Team
              </h3>

  ...
  return <section className="py-24 ocean-abyss relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          {/* Discord */}
          <Card className="underwater-glass border-border/30 hover:border-primary/50 transition-all duration-300">
          ...
          {/* Email */}
          <Card className="underwater-glass border-border/30 hover:border-accent/50 transition-all duration-300">
            <CardContent className="p-8 text-center">

  ...
  return <section className="py-16 ocean-shallow relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {features.map((feature, index) => <Card key={index} className="underwater-glass border-border/30 hover:border-primary/50 hover:scale-105 hover:shadow-xl transition-all duration-300 wave-motion" style={{

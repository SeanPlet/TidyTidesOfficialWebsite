    ...
    <section className="py-16 ocean-medium relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold font-sour-gummy text-primary mb-6 break-words" style={{WebkitTextStroke: '2px #004258'}}>Patch Notes</h2>
